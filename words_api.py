...
def get_sentences_from_file(filename: str, lang: str = "english") -> List[str]:
...
def find_words(sentences: List[str], words: List[str], min_len: int, max_len: int, examples: int) -> dict:
    ret = []
